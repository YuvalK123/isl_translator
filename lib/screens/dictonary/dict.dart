...
class _DictionaryState extends State<Dictionary> {
  ...
  List<Card> _buildGridCards(BuildContext context) {
    ButtonImage holidays = new ButtonImage(
        "hanukkah.jfif", "חגים ומועדים", SubjectName.HOLIDAYS);
    ButtonImage pronoun = new ButtonImage(
        "pointing.jfif", "כינוי גוף", SubjectName.PRONOUNS);
    ButtonImage animals = new ButtonImage(
        "animals.jfif", "בעלי חיים", SubjectName.ANIMALS);
    ButtonImage shapes = new ButtonImage(
        "shapes.jfif", "צורות", SubjectName.SHAPES);
    ButtonImage body = new ButtonImage(
        "body.jfif", "גוף האדם", SubjectName.BODY);
    ButtonImage time = new ButtonImage("time.jfif", "זמן",SubjectName.TIMES);
    ButtonImage geography = new ButtonImage(
        "geography.jfif", "גאוגרפיה", SubjectName.GEOG);
